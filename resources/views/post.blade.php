    ...
    {{-- <article class="py-8 max-w-screen-md border-b border-neutral-300">
        ...
        <div>
            ...
            <a href="/authors/{{ $post->author->username }}"
                class="text-base text-neutral-500 hover:underline ">{{ $post->author->name }}</a>
            in
            <a href="/categories/{{ $post->category->slug }}"
                class="text-base text-neutral-500 hover:underline ">{{ $post->category->name }}</a>
        ...
        <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
            <article
                ...
                <header class="mb-4 lg:mb-6 not-format">
                    <a href="/posts" class="font-medium text-sm text-blue-600">&laquo; Back to all post</a>
